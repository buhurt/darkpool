 ...
 * @property WestFavorites[] $favorites
 */
class User extends ActiveRecord implements IdentityInterface
{
    ...
    {
        return $this->hasMany(AuthLog::class, ['user_id' => 'id'])->alias('authLog')->orderBy('id DESC')->limit(20);
    }
    ...
    {
        return $this->hasMany(WestFavorites::class, ['created_by' => 'id'])->with('tickerInfo')->alias('favorites')->orderBy('id DESC');
    }
    ...
    {
        /** @var Mailer $mailer */ /** @var Message $message */
        ...
        $result = $mailer->compose('confirmEmail', compact("subject", "user", "profile", "userToken"))->setTo($email)->setSubject($subject)->send();
