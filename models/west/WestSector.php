...
/**
 * This is the model class for table "west.sector".
 *
 * @property int $id
 ...
 */
class WestSector extends ActiveRecord
{
    /**
     * {@inheritdoc}
     */
     ...
     * @return int
     */
    public static function getSectorIdIfExist($name)
    {
     ...
     * @return WestSector
     */
    public static function create($name): WestSector
    {
        $model = new self();
        $model->name = $name;
        $model->save();
